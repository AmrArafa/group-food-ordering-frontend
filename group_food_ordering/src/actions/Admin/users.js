...
import { AdminusersApi, AdminuserApi } from '../../apiConfig';
...
export const getUsers = () => {
    const payload = Axios.get(AdminusersApi);
    return {
        type: GET_USERS,
        payload
    }
...
export const getUser = (id) => {
    const payload = Axios.get(AdminuserApi(id));
    return {
        type: GET_USER,
        payload
    }
...
export const addUser = (user) => {
    const payload = Axios.post(AdminusersApi, 
        user
    );
    return {
        type: ADD_USER,
...
export const editUser = (id, user) => {
    const payload = Axios.patch(AdminuserApi(id), user);
    return {
        type: EDIT_USER,
        payload
    }
...
export const deleteUser = (id) => {
    const payload = Axios.delete(AdminuserApi(id));
    return {
        type: DELETE_USER,
        payload
    }
